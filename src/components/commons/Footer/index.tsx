...
function Footer() {
    return (
        <div className="Footer">
            <div className="Footer_availableInContainer">
                <h1>Available In </h1>
                <ul>
                    {footerData.availableIn.map((elm, ix) => {
                        return (
                            <li key={ix}>
            ...
            <div className="Footer_quickLinks">
                {footerData.sections.map((elm, ix) => {
                    return (
                        <div key={ix} className="Footer_quickLinks_section">
                            <h1>{elm.title}</h1>
                            <ul>
                                {elm.items.map((elem, idx) => {
                                    return (
                                        <li key={idx}>
                                            <a href={elem.url} target={elem.target || ""}>
                                                {elem.name}
                                            </a>
                                        </li>
                                    );
